...
def test_links_comparison():
    assert UrlUtils.is_equal(base_uri, "http://foo.com", "http://foo.com/") is True
    assert UrlUtils.is_equal(base_uri, "http://foo.com", "/") is True
    assert UrlUtils.is_equal(base_uri, "http://foo.com/foo.html#bar", "http://foo.com/foo.html#foo") is False